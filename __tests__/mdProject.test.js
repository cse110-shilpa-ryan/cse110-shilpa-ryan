...
describe('Basic testing of Markdown previewer', () => {
    ...
    it('Add text in text area and confirm', async () => {
    ...
    it('Confirm correct HTML generated by marked', async () => {
    ...
    it('Confirm it saves text after reload', async () => {
        await page.reload();
    ...
    it('Confirm number of line numbers', async () => {
    ...
    it('Confirm it deletes notes', async () => {
        await page.click('textarea');
